...
(test the-codec-emits-only-plain-data
  "The sexp form is deliberately a tree of values any ordinary serializer
already handles, so an extent can cross a storage or wire boundary without
reserving a type of its own: every leaf is a keyword, an integer, NIL, or a
