...
subsystem must not define one.  An edit that adds one fails here."
  (is-false (find-symbol "STANDING<" :temporal-extent))
  (is-false (find-symbol "STANDING-WEAKEST" :temporal-extent))
  (is-false (find-symbol "STANDING-WEAKER" :temporal-extent)))
